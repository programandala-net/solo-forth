...
Since the maximun capacity of TR-DOS disks is only 640 KiB, the
library is split into two disks.
...
+
--
Notice that the TR-DOS version of Solo Forth uses numbers as disk
