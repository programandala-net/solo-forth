...
inspiration from the following works, listed in alphabetical order:
...
- Z80 data collected by Oscar Lindberg, 1996-03-24.
- Z80 data prepared by Devin Gardner, 2000-04-29.
