...
----
: default-display ( -- )
  default-mode reset-default-mode default-font default-colors ;
----
...
- Use `needing X 0(` instead of `[unneeded] X ?(`, i.e. with
...
Rename `[unneeded]` `unneeding` (`ignoring`?) and make it non-immediate.  Write
an immediate optional version `[unneeding]`.
