...
- Link to `\` in `(` is ruined.
- Link to `*/-` in `*/_` is ruined.  Possible solution: Escape ++"*"++
  in Glosara.
- Link to `*/_` in `*/` is ruined.  Possible solution: Escape ++"/"++
  in Glosara.
- "See:" links to `"y"` and `"n"` have a ';' at the end.  This looks a
  Gforth issue with string manipulation.
- "See:" link to `f~abs` in `f~` has a ';' at the end. This looks a
  Gforth issue with string manipulation.
- "See:" link to `|**` in `|sqrt` has a ';' at the end. This looks a
  Gforth issue with string manipulation.
- "See:" links of `|>=` are ruined. Solution: Escape ++<++ in Glosara.
- Link to `f==` in `f~` is ruined.
...
- Link to `>resolve` in `then` has a 'v' at the end. This looks a
  Gforth issue with string manipulation.
- Link to `ms>ticks` in `ticks` is ruined.
- "See:" links in `u<=` are ruined.
- "See:" links in `<=` are ruined.
- "See:" links in `<=>` are ruined.
- "See:" links in `<>` are ruined.
- "See:" links in `>=` are ruined.
- Some "See:" links in `>name` are ruined.
- Some "See:" links in `>oldest-name/fast` are ruined.
- Some "See:" links in `>oldest-name/order` are ruined.
- Some "See:" links in `?(` are ruined.
