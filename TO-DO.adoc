...
Check the parsing of Asciidoctor markup `+`, example:

----
  \ This is the same as +3 lshift+ or +2* 2* 2*+, but faster.
----
...
Replace backticks markup with pluses in the "Origin" section of the
glossary entries, because words backticks are cross references.

Already done in the main kernel.
