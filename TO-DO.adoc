...
Finish `ltype`.
Make it compatible with Galope's `ltype`.
...
Rename "ticks" words "dticks" and write 1-cell "ticks" versions?
...
Changes under development on 2017-11-28.
