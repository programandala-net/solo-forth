...
Deactivate documentation of `system` and friends.
...
Homogenize notation `..` for intervals and notation `...` for
ellipsis.

Some structures lack any; see `default-option`.
