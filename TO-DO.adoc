...
Rewrite a common routine to enter TR-DOS, preserving the Forth IP,
modifying the DF_SZ system variable as needed by TR-DOS, and restoring
IX at the end, if needed.
