...
Add a variable to count the number of definitions in the dictionary.  It must
be updated by the assembler macro during the assembly of the kernel, and also
by `header,`. Show its value in `greeting` and `fyi`.
