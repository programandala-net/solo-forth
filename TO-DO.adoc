...
Add "``X`` is an `immediate` word" or "``X`` is an `immediate` and
`compile-only` word" to the library documentation.  Already done in
the kernel.
...
Make `.unused` show also the number of banks, or the total RAM.  Add
also the description of the free spaces:

....
RAM: 128 KiB
Free data/code space: 32000 B
Free name space: 52000 B
....

....
RAM: 128 KiB
Data/code space: 32000 B free
Name space: 52000 B free
....
...
....
128 KiB RAM
32000 B free data/code space
52000 B free name space
....
