...
- Rename the editors. Create dummy words `blocked-editor` in
  <prog.editor.blocked.fs> and `specforth-editor` in
  <prog.editor.specforth.fs>, document them with the main instructions
  and a reference to the source code.
- Deactivate the Glosara markers in <prog.editor.specforth.fs>.
