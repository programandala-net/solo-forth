...
Add `pushhlde` to the library. Calculate it from `pushhl`.
...
Recently introduced bug: the system crashes at `1 load`. Something to
do with recent removing of `pushhl,`, etc.
