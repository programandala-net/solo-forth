...
match, not the first one. This is slow.

Solution 2: Mark aliases and synonyms with a bit in the header.

Solution 3: Distinguish aliases and synonyms using the content of its
code field address, e.g. using a specific jump or compiling a Z80 noop
first.
