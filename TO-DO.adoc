...
Fix compilation of `mode42` and `mode64`: It seems a circular requirement
makes part of the assembler be compiled twice.
...
Words that can be moved to the library: `there`, `catch`, `printer`, `?\`,
`[defined]`, `[undefined]`...
