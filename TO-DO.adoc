...
.2017-01-20, 2017-01-21, 2017-12-12:
...
with the _xt_ that is searched for. This is slow, but saves the
additional link.

NOTE: If the search is done backwards, the names of the aliases will
be found first. Now the names or the original words are found first.
Therefore perhaps some aliases defined in the kernel should be moved
before their corresponding original.
