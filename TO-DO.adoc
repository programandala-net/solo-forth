...
Fix +3DOS `(cat`, which return ior #-1020 the first time it's
executed. It seems the bug has been introduced after adding `acat` and
`wacat`, but the shared code has not changed.
