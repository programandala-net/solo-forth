...
Fix: Make `cold` set the default action of `init-asm`.

.2017-03-21:

Reduce the size of `l-refs`: Combine byte 0 and 1 into one. Use the
...
register. Move all "xy>" words to the cursor module.
