...
Table cells justification and columns percentage width are ignored by
Asciidoctor EPUB3. They are correct in the PDF made by Asciidoctor
PDF. For example, see `specforth-editor` and `banks`.
