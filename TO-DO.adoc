...
.2017-01-09, 2017-01-12, 2017-01-13, 2017-01-23:
...
But "color" is ambiguous. It's not exactly a synonym of "color attribute".
Alternative:
...
| `color!`            | `attr!`
| `color@`            | `attr@`
| `color-mask!`       | `attr-mask!`
| `color-mask@`       | `attr-mask@`
| `permcolor!`        | `perm-attr!`
| `permcolor@`        | `perm-attr!`
| `permcolor-mask!`   | `perm-attr-mask!`
| `permcolor-mask@`   | `perm-attr-mask@`
| `permanent-colors`  | `permanent-attrs`
| `permcolor@`        | `perm-attr@`
|                     | `xy-attr!`
|                     | `xy-attr@`
|                     | `gxy-attr!`
...
.2016-12-02, 2017-01-23:

Factor `inverse` to `inverse-on` and `inverse-off`.

Factor `overprint` to `overprint-on` and `overprint-off`.

Or write alternatives to `inverse` and `overprint`, for speed:
`+inverse`, `-inverse`, `+overprint`, `-overprint`.
