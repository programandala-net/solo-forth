...
The following tests are not passed:
...
And so all tests using those constants.

|===
| Constant | Decimal     | Binary

| max-2int |  2147483647 | 01111111111111111111111111111111
| min-2int | -2147483648 | 10000000000000000000000000000000
| hi-2int  |  1073741823 | 00111111111111111111111111111111
| lo-2int  | -1073741824 | 11000000000000000000000000000000
|===

The reason is `d2/` is buggy.
