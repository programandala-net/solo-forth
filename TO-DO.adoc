...
- Update pronunciation of words in quotes, e.g. `"y"` should be
  "quote-y-quote".
...
- Link the words mentioned in the description of exception codes.

=== 2018-07-20

NOTE: Milestone: 0.14.0

- Replace "%DOS%" label with Asciidoctor attribute `{dosname}`, set by the
