...
- Factor the setting of the library disks from section "How to use the
  library", and link that part from "How to load a program that needs the
  library" and "How to test and benchmark".
...
Or convert `?stringer` into an optional checker.
A mandatory check is a waste of resources.
