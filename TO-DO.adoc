...
- Simplify section _Future targets_: Use a table instead.
- Remove section _Summary of the DOS support_. Use the table of section
  _Comparative of DOS support_ instead.
- Since htmldoc is not used anymore, restore the graphic tree in section
  _Project directories_. 
- Confirm corrupted links with backslash and remove the corresponding note.
- Move section _Comparative of block access speed_ to the benchmarks module.
