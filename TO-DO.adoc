...
Fix: `load` corrupts the system, even with empty screens. (Already solved
by rewritting `enclose`?).
...
Fix: A second bug related to parsing: something fails when the parsing
of the screen passes from the first to the second disk block.
