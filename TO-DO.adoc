...
2017-01-06: Fixed! It was a very subtle bug in `find-name-from`: a previous
word of the same length than the latest one was not found after crossing the
16-KiB boundary...

After the solution: 31936 B free. But an improved version is possible.
