...
1. Run a ZX Spectrum emulator to emulater a ZX Spectrum 128 with the +D disk interface.
2. "Insert" the file <solo_forth_disk_1.mgt> as disk 1 of the +D disk interface.
