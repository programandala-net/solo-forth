...
- Support for NextZXOS on the ZX Spectrum Next.
...
Original title:: Un beau matin il sortit dans la campagne.

Illustrator:: Forest, Eugène Hippolyte (1808- ?)

Engraver:: Pouget, Jean-Achille (19th century)

Edition:: 1866, Paris, Histoire de l'admirable Don Quichotte de la
Manche (Hachette et Cie.)
...
Dimensiones: 95 x 73 mm.

Episode:: Primera salida de don Quijote
 
Título/s:: Salida por el corral de la casa Don Quijote conversa
consigo mismo sobre sus futuras hazañas

////

The ZX Spectrum image was created from
http://www.cervantesvirtual.com/portales/quijote_banco_imagenes_qbi/ficha_imagen/?id=13763[image
13763 of the QBI image bank].
...
1863, Paris, _L'ingénieux hidalgo Don Quichotte de la Manche_
