...
\ ----
\ patch_the_loader.fs symbols.z80s raw_loader.bas patched_loader.bas
\ ----
...
\
\ 2017-03-10: Add example usage to the file header. Update the
\ code style. Change the order of the parameters and make
\ parameters greater than 3 be ignored, after the changes in
\ Makefile.
...
1 arg 2constant patched-loader-file
2 arg 2constant symbols-file
3 arg 2constant raw-loader-file

argc off \ Ignore any other possible argument,
         \ which is just a dependency in the Makefile.
