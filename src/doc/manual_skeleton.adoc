...
:producer: Marcos Cruz (programandala.net)
:revdate: 2020-05-03
:doctype: book
:lang: en
:toc:
...
:source:
ifdef::backend-epub3[]
:copyright: 2015-2020 Marcos Cruz
endif::[]

// This file is part of Solo Forth
// http://programandala.net/en.program.solo_forth.html

// Last modified: 202005032043
...
- One double-sided 80-track disk drive (two recommended), for 720-KiB disks.
  Therefore, the original single-sided 40-track disk drive (173 KiB per disk
...
- One double-sided 80-track disk drive (three recommended), for 640-KiB disks.
  Other disk formats can be used, but only for files, not as block disks.
...
<<_description,description of the Forth system>>, the basic <<_how_to_run,usage
...
Block disks are fully supported on +3DOS, but most file-management words are
...
Block disks are fully supported on G+DOS, but some file-management words are
...
Block disks are fully supported on TR-DOS , but many file-management words are
not implemented yet, especially the standard Forth words.
...
// Create attributes to make the table entries be rendered by Glosara
// as links only if the Forth word is provided by the current DOS.
// Words defined in all of the DOS variants, or in none of them, are
// hardcoded in the table.

ifdef::plus3dos[:3-block-drives: ``3-block-drives``]
ifdef::gplusdos[:3-block-drives: ``3-block-drives``]
ifdef::trdos[:3-block-drives: `3-block-drives`]
ifdef::plus3dos[:4-block-drives: ``4-block-drives``]
ifdef::gplusdos[:4-block-drives: ``4-block-drives``]
ifdef::trdos[:4-block-drives: `4-block-drives`]
ifdef::plus3dos[:greater-than-file: ``>file``]
ifdef::gplusdos[:greater-than-file: `>file`]
ifdef::trdos[:greater-than-file: `>file`]
ifdef::plus3dos[:bank-read-file: `bank-read-file`]
ifdef::gplusdos[:bank-read-file: ``bank-read-file`]
ifdef::trdos[:bank-read-file: ``bank-read-file`]
ifdef::plus3dos[:bank-write-file: `bank-write-file`]
ifdef::gplusdos[:bank-write-file: ``bank-write-file``]
ifdef::trdos[:bank-write-file: ``bank-write-file`]
ifdef::plus3dos[:bin: `bin`]
ifdef::gplusdos[:bin: `bin`]
ifdef::trdos[:bin: ``bin``]
ifdef::plus3dos[:close-file: ``close-file``]
ifdef::gplusdos[:close-file: `close-file`]
ifdef::trdos[:close-file: `close-file`]
ifdef::plus3dos[:create-file: ``create-file``]
ifdef::gplusdos[:create-file: `create-file`]
ifdef::trdos[:create-file: `create-file`]
ifdef::plus3dos[:drive-unused: `drive-unused`]
ifdef::gplusdos[:drive-unused: ``drive-unused``]
ifdef::trdos[:drive-unused: ``drive-unused``]
ifdef::plus3dos[:file-dir-number-sign: ``file-dir#``]
ifdef::gplusdos[:file-dir-number-sign: `file-dir#`]
ifdef::trdos[:file-dir-number-sign: `file-dir#`]
ifdef::plus3dos[:file-dirdesc: ``file-dirdesc``]
ifdef::gplusdos[:file-dirdesc: `file-dirdesc`]
ifdef::trdos[:file-dirdesc: ``file-dirdesc``]
ifdef::plus3dos[:file-exists-question: ``file-exists?``]
ifdef::gplusdos[:file-exists-question: `file-exists?`]
ifdef::trdos[:file-exists-question: `file-exists?`]
ifdef::plus3dos[:file-length: ``file-length``]
ifdef::gplusdos[:file-length: `file-length`]
ifdef::trdos[:file-length: `file-length`]
ifdef::plus3dos[:file-position: `file-position`]
ifdef::gplusdos[:file-position: ``file-position``]
ifdef::trdos[:file-position: ``file-position``]
ifdef::plus3dos[:file-sector: ``file-sector``]
ifdef::gplusdos[:file-sector: ``file-sector``]
ifdef::trdos[:file-sector: `file-sector`]
ifdef::plus3dos[:file-sectors: ``file-sectors``]
ifdef::gplusdos[:file-sectors: ``file-sectors``]
ifdef::trdos[:file-sectors: `file-sectors`]
ifdef::plus3dos[:file-size: `file-size`]
ifdef::gplusdos[:file-size: ``file-size``]
ifdef::trdos[:file-size: ``file-size``]
ifdef::plus3dos[:file-start: ``file-start``]
ifdef::gplusdos[:file-start: `file-start`]
ifdef::trdos[:file-start: `file-start`]
ifdef::plus3dos[:file-status: ``file-status``]
ifdef::gplusdos[:file-status: `file-status`]
ifdef::trdos[:file-status: `file-status`]
ifdef::plus3dos[:file-track: ``file-track``]
ifdef::gplusdos[:file-track: ``file-track``]
ifdef::trdos[:file-track: `file-track`]
ifdef::plus3dos[:file-type: ``file-type``]
ifdef::gplusdos[:file-type: `file-type`]
ifdef::trdos[:file-type: `file-type`]
ifdef::plus3dos[:file-greater-than: ``file>``]
ifdef::gplusdos[:file-greater-than: `file>`]
ifdef::trdos[:file-greater-than: `file>`]
ifdef::plus3dos[:find-file: ``find-file``]
ifdef::gplusdos[:find-file: `find-file`]
ifdef::trdos[:find-file: `find-file`]
ifdef::plus3dos[:flush-drive: `flush-drive`]
ifdef::gplusdos[:flush-drive: ``flush-drive``]
ifdef::trdos[:flush-drive: ``flush-drive``]
ifdef::plus3dos[:open-file: `open-file`]
ifdef::gplusdos[:open-file: ``open-file``]
ifdef::trdos[:open-file: ``open-file``]
ifdef::plus3dos[:r-slash-o: `r/o`]
ifdef::gplusdos[:r-slash-o: ``r/o``]
ifdef::trdos[:r-slash-o: ``r/o``]
ifdef::plus3dos[:r-slash-w: `r/w`]
ifdef::gplusdos[:r-slash-w: ``r/w``]
ifdef::trdos[:r-slash-w: ``r/w``]
ifdef::plus3dos[:read-byte: `read-byte`]
ifdef::gplusdos[:read-byte: ``read-byte``]
ifdef::trdos[:read-byte: ``read-byte``]
ifdef::plus3dos[:read-file: `read-file`]
ifdef::gplusdos[:read-file: ``read-file``]
ifdef::trdos[:read-file: ``read-file``]
ifdef::plus3dos[:read-line: `read-line`]
ifdef::gplusdos[:read-line: ``read-line``]
ifdef::trdos[:read-line: ``read-line``]
ifdef::plus3dos[:reposition-file: `reposition-file`]
ifdef::gplusdos[:reposition-file: ``reposition-file``]
ifdef::trdos[:reposition-file: ``reposition-file``]
ifdef::plus3dos[:undelete-file: ``undelete-file``]
ifdef::gplusdos[:undelete-file: ``undelete-file``]
ifdef::trdos[:undelete-file: `undelete-file`]
ifdef::plus3dos[:w-slash-o: `w/o`]
ifdef::gplusdos[:w-slash-o: ``w/o``]
ifdef::trdos[:w-slash-o: ``w/o``]
ifdef::plus3dos[:wacat: `wacat`]
ifdef::gplusdos[:wacat: `wacat`]
ifdef::trdos[:wacat: ``wacat``]
ifdef::plus3dos[:wcat: `wcat`]
ifdef::gplusdos[:wcat: `wcat`]
ifdef::trdos[:wcat: ``wcat``]
ifdef::plus3dos[:write-byte: `write-byte`]
ifdef::gplusdos[:write-byte: ``write-byte``]
ifdef::trdos[:write-byte: ``write-byte``]
ifdef::plus3dos[:write-file: `write-file`]
ifdef::gplusdos[:write-file: ``write-file``]
ifdef::trdos[:write-file: ``write-file``]
ifdef::plus3dos[:write-line: `write-line`]
ifdef::gplusdos[:write-line: ``write-line``]
ifdef::trdos[:write-line: ``write-line``]
...
| {greater-than-file}    |       | YES   | YES    | Save memory zone to a file
...
| {drive-unused}         | YES   |       |        | Return the number of unused kibibytes in a drive
| {file-dir-number-sign} |       | YES   | YES    | Return the directory number of a file
| {file-dirdesc}         |       | YES   | n/a    | Return the file directory identifier of a file
| {file-exists-question} |       | YES   | YES    | Return a flag: does a files exists?
...
| {file-greater-than}    |       | YES   | YES    | Load file contents to memory zone
...
| {r-slash-o}            | YES   |       |        | Standard Forth
| {r-slash-w}            | YES   |       |        | Standard Forth
...
ifdef::plus3dos[]
include::doc.README.linked.adoc[tags=run_plus3]
endif::plus3dos[]
ifdef::trdos[]
include::doc.README.linked.adoc[tags=run_128_with_betadisk]
endif::trdos[]
ifdef::gplusdos[]
include::doc.README.linked.adoc[tags=run_128_with_plusd]
endif::gplusdos[]
...
[cols="6,11,11,7,18"]
.Time and memory required to make the library index{blank}footnote:[pass:a[{indexnote}]]
|===
...
[cols="6,10,10,10,10"]
.Range of blocks per drive on every DOS, in normal order
|===
...
. <<_how_to_run,Run Solo Forth>> or enter `cold` to start from scratch.
...
. Convert the sources into Forth block disk images using
  http://programandala.net/en.program.fsb2.html[fsb2].
. <<_how_to_run,Run Solo Forth>> on a ZX Spectrum emulator and compile the Forth
...
The only difference between <<_how_to_rebuild_solo_forth,building Solo Forth>> and
...
|===
| DOS    | All formats          | DocBook              | EPUB                  | HTML                  | ODT                  | PDF

| All    | ``make doc``         | ``make dbk``         | ``make epub``         | ``make html``         | ``make odt``         | ``make pdf``
| +3DOS  | ``make plus3dosdoc`` | ``make plus3dosdbk`` | ``make plus3dosepub`` | ``make plus3doshtml`` | ``make plus3dosodt`` | ``make plus3dospdf``
| G+DOS  | ``make gplusdosdoc`` | ``make gplusdosdbk`` | ``make gplusdosepub`` | ``make gplusdoshtml`` | ``make gplusdosodt`` | ``make gplusdospdf``
| TR-DOS | ``make trdosdoc``    | ``make trdosdbk``    | ``make trdosepub``    | ``make trdoshtml``    | ``make trdosodt``    | ``make trdospdf``
|===

NOTE: The manuals in ODT are not built by default. Two versions of
EPUB and two versions of HTML are built, with different tools.
...
Exception codes (also called `throw` values) are used as prescribed by the
Forth-2012 standard: codes -255..-1 are used only as assigned by the standard,
and codes -4095..-256 are reserved for Solo Forth.  Therefore, programs shall
not define values for use with `throw` in the range -4095..-1.

[%autowidth]
.Ranges of exception codes
|===
| Range         | Reserved for
...
the <<_how_to_use_the_library,library>> with ``need .throw-message``.
