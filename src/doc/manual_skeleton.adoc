...
| YES   |       |        | Return the number of unused kibibytes in a drive

|
ifdef::plus3dos[``file-dir#``]
ifdef::gplusdos[`file-dir#`]
ifdef::trdos[`file-dir#`]
|       | YES   | YES    | Return the directory number of a file

|
ifdef::plus3dos[``file-dirdesc``]
ifdef::gplusdos[`file-dirdesc`]
ifdef::trdos[``file-dirdesc``]
|       | YES   | n/a    | Return the file directory identifier of a file
