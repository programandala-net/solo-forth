...
|===
| DOS    | All formats          | EPUB                  | HTML                  | ODT                  | PDF

| All    | ``make doc``         | ``make epub``         | ``make html``         | ``make odt``         | ``make pdf``
| +3DOS  | ``make plus3dosdoc`` | ``make plus3dosepub`` | ``make plus3doshtml`` | ``make plus3dosodt`` | ``make plus3dospdf``
| G+DOS  | ``make gplusdosdoc`` | ``make gplusdosepub`` | ``make gplusdoshtml`` | ``make gplusdosodt`` | ``make gplusdospdf``
| TR-DOS | ``make trdosdoc``    | ``make trdosepub``    | ``make trdoshtml``    | ``make trdosodt``    | ``make trdospdf``
|===
