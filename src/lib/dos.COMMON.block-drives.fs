  ...
  \ Code to handle blocks directly in disk-drives, common to
  \ the diskette-based DOSes: +3DOS, G+DOS and TR-DOS.
...
( set-block-drives get-block-drives )
...
: get-block-drives ( -- c#n..c#1 n | 0 )
  ...
  \ --------------------------------------------
  \ As <dos.COMMON.block-drives.fs>

  \ 2021-01-07: Start. Copy frem <dos.COMMON.fs> all of the
  \ words that manage blocks directly in diskettes, shared by
  \ +3DOS, G+DOS and TR-DOS.
